...
df['عدد الركاب'] = df['عدد الركاب'].astype(int)
with open(f'/Volumes/ahmed/car_auction_data/kcar/text_data/alfaqih_data2025-05-21.txt') as f:
    html = f.read()
...
def parse_htmls(htmls):
    ...
    for i in htmls:
        car_data={
            'auction_date':"22/05/2025 08:00 AM",
            'category':'auction',
        ...
        dict_list = filter_cars_by_year(dict_list, 2019)
