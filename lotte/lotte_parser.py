...
# Sample string
auction_date_str = "02/05/2025 08:00 AM"

df = pd.read_csv('/Users/amd/Downloads/alfaqih - sheet1 (2).csv')
    ...
    def parsing_detail(self) -> None:
        ...
        for i in dict_list:
            ...
            try:
                ...
                i['price'] = int(get_matching_value(df,i['entry'],'سعر السيارة').replace(',',''))
