...
# print(len(all_data))
with open(f'autohub/autuhub_data/final_json/detail_json_mnaf_2025-04-15.json') as f:
...
entries = df['رقم الاعلان'].astype(str).tolist()

print([i for i in entries])
filtered_cars = [i for i in all_data if i['entry'] in entries]
...
Parser().export_json(filtered_cars,f'autohub/autuhub_data/final_json/autohub_{TODAY}_alfaqih1.json')
# for i in filtered_cars:
#     print(i['price'])
# f_cars=[]
# for i in all_data:
