...
if __name__ == "__main__":
    file_path=f'/Volumes/ahmed/car_auction_data/autohub/jsion_data/autohub_urls_{HOUR}.json'
    with open(file_path) as j:
        urls = json.load(j)['car_urls']
    selector = '.car_blueprintnew'  # Adjust this selector based on your needs
    output_file = f'/Volumes/ahmed/car_auction_data/autohub/text_data/autohub_data_{TODAY}.txt'
